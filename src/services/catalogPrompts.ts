...
REQUIRED OUTPUT (JSON only, no other text):
{
  ...
  "character_archetypes": ["1-3 character patterns, e.g., strong female lead, anti-hero, chosen one, grumpy sunshine"],
  "content_warnings": ["relevant warnings only, e.g., violence, death, abuse"],
  ...
  "perfect_for": "Specific audience recommendation (e.g. 'Fans of A Court of Thorns and Roses who want more politics')",
  "memorable_quote": "A famous or representative quote from the book (null if unknown)",
